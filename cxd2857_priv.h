...
#define AUTO \
	(0xFF) /* For IF_OUT_SEL and AGC_SEL, it means that the value is desided by config flags. */
...
enum sony_ascot3_tv_system_t {
	...
	SONY_ASCOT3_ATV_MIN =
		SONY_ASCOT3_ATV_MN_EIAJ, /**< Minimum analog terrestrial system */
	SONY_ASCOT3_ATV_MAX =
		SONY_ASCOT3_ATV_L_DASH, /**< Maximum analog terrestrial system */
	SONY_ASCOT3_DTV_MIN =
		SONY_ASCOT3_DTV_8VSB, /**< Minimum digital terrestrial system */
	SONY_ASCOT3_DTV_MAX =
		SONY_ASCOT3_DTV_DTMB, /**< Maximum digital terrestrial system */
...
enum sony_freia_tv_system_t {
	...
	SONY_FREIA_ATV_MIN =
		SONY_FREIA_ATV_MN_EIAJ, /**< Minimum analog terrestrial system */
	SONY_FREIA_ATV_MAX =
		SONY_FREIA_ATV_L_DASH, /**< Maximum analog terrestrial system */
	SONY_FREIA_DTV_MIN =
		SONY_FREIA_DTV_8VSB, /**< Minimum digital terrestrial system */
	SONY_FREIA_DTV_MAX =
		SONY_FREIA_DTV_DTMB, /**< Maximum digital terrestrial system */
	SONY_FREIA_TERR_TV_SYSTEM_NUM, /**< Number of supported terrestrial broadcasting system */
	SONY_FREIA_STV_MIN =
		SONY_FREIA_STV_ISDBS, /**< Minimum satellite system */
	SONY_FREIA_STV_MAX =
		SONY_FREIA_STV_DVBS2 /**< Maximum satellite system */
};

#define SONY_FREIA_IS_DVB_T_T2(tvSystem)             \
...
enum sony_dtv_bandwidth_t {
	...
	SONY_DTV_BW_J83B_5_06_5_36_MSPS =
		50, /**< For J.83B. 5.06/5.36Msps auto selection commonly used in US. */
	SONY_DTV_BW_J83B_5_60_MSPS =
		51 /**< For J.83B. 5.6Msps used by SKY PerfecTV! Hikari in Japan. */
};
